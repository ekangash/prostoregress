...
export const metadata: Metadata = {
    title: 'Интересные публикации авторов — unstock.',
    description: 'Забудьте о необходимости беспокоиться о потере важных данных и избавьтесь от неудобных процессов управления заметками. Воспользуйтесь нашим удобным и интуитивно понятным инструментом для хранения и организации данных.',
}
